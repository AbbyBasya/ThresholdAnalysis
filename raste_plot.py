...
def event_plot(df, save_dir, mouse_id='', exp_date='', filename='test', save=False, width=3.5, figuresize=[12, 20],
    ...
    for i, row in df.iterrows():
        plt.hlines(i, (row['go_odor'][1])-2, row['go_odor'][1], color=gocolor, alpha=1,
        ...
        plt.hlines(i, (row['nogo_odor'][1])-2, row['nogo_odor'][1], color=nogocolor, alpha=1,
...
mouse_names = ['S2_post_iso']

path = 'G:/My Drive/behavior data/experiment_data_2022_3_cheat_go_no'
